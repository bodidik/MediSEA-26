...
// KAPTANIN DİNAMİK KART OKUYUCUSU
export default async function FlashcardsPage({
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-slate-950">
        <div className="bg-red-900/20 text-red-400 p-8 rounded-2xl border border-red-500/30 text-center shadow-2xl">
          ...
          <p className="text-sm">Gidilecek branş veya kart destesi belirtilmedi.</p>
        </div>
      </div>
    );
  }
  ...
  try {
    // Dinamik Dosya Yolu: content/premium/ydus/flashcards/hematoloji/aml.json
    ...
    console.error("Flashcard veri okuma hatası:", error);
    return (
      <div className="flex h-screen items-center justify-center bg-slate-950">
        <div className="bg-slate-900 text-slate-400 p-8 rounded-2xl border border-slate-800 text-center shadow-2xl">
          <span className="text-4xl mb-4 block">🌊</span>
          <h2 className="text-2xl font-black text-white tracking-widest uppercase mb-2">Deste Bulunamadı</h2>
          <p className="text-sm">
